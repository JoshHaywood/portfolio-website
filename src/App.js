    ...
    <>
      ...
      <Routes>
        ...
        <Route
          ...
          element={
            <>
              {/* Alters delay based on if loading screen had rendered */}
              {loading ? (
                <Projects containerDelay={3.3} childDelay={3.8} />
              ) : (
                <>
        ...
        <Route
          ...
          element={
            <>
              {loading ? (
                <ContactPage delay={3.3} />
              ) : (
                <ContactPage delay={0.5} />
              )}
            </>
          }
        />
