        ...
        <>
            ...
            <div className="flex flex-col md:flex-row max-w-[1000px] mx-auto py-16 md:py-32 px-5">
                ...
                >
                    ...
                    <div className="absolute top-0 md:top-[5rem] bottom-0 flex flex-row md:flex-col md:left-0 right-0 items-center space-x-3 md:space-x-0 md:space-y-10 pb-10 md:pb-0">
