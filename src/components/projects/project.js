    ...
    return (
        <>
            <div className="relative flex flex-col justify-center mt-[4.75rem]">
                ...
                {/* Heading */}
                <div className="absolute text-center left-0 right-0"> {/* Parent with position to not interfere with inline-block */}
            ...
            <div className="flex flex-col md:flex-row max-w-[1000px] mx-auto py-16 md:py-32 px-5">
                {/* Article */}
                <div className="w-full md:w-4/5 mr-5 order-2 md:order-1 space-y-10">
                    <p>{props.overview}</p>
                ...
                {/* Side menu */}
                <div className="w-full md:w-1/5 mx-auto py-5 md:py-0 relative order-1 md:order-2 md:text-center ">
                    <Button
                        onClick={() => navigate(-1)}
                        variant="contained"
                    ...
                    <div className="absolute top-0 md:top-[8vh] bottom-0 flex flex-row md:flex-col md:left-0 right-0 items-center space-x-3 md:space-x-0 md:space-y-10">
                        <a href={props.projectLink}>
                            <svg className="h-8 w-8 fill-secondary-text hover:fill-secondary-text-hover transition duration-300 ease-in-out" xmlns="http://www.w3.org/2000/svg" alt="globe icon" viewBox="0 0 512 512"> {/*! Font Awesome Pro 6.0.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. */} 
