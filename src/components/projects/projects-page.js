        ...
        <>
            ...
            >        
                ...
                <motion.div variants={containerVariants} initial="hidden" whileInView="visible" viewport={{ once: true }} className="space-y-8 lg:space-y-0 lg:grid grid-rows-2 grid-cols-2 xl:grid-cols-3 gap-x-5 gap-y-6"> 
                    {items.map((items) => 
                        //Project card                            
                        <motion.div variants={listVariants} className="shadow-md shadow-[rgba(76,107,193,0.2)] rounded-md sm:mx-20 md:mx-36 lg:mx-0 hover:-translate-y-4 transition duration-300 ease-in-out">
                                ...
                                <div className="flex justify-between">
                                    ...
                                    <div className="flex flex-row space-x-2">
                                        <a href={items.projectLink}>
                                            <svg className="h-auto w-5 pt-[1.3rem] fill-secondary-text hover:fill-secondary-text-hover transition duration-300 ease-in-out" xmlns="http://www.w3.org/2000/svg" alt="globe icon" viewBox="0 0 512 512"> {/*! Font Awesome Pro 6.0.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. */} 
