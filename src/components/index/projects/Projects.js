  ...
  function AlignedRightCard() {
    return (
      sidebar ? (
        ...
        >
          {/* Image */}
          <div class="hidden md:block md:w-3/5 md:relative md:overflow-hidden">
          ...
          {/* Project information */}
          <div class="p-5 sm:px-5 md:px-0 sm:py-16 md:py-10 backdrop-brightness-[0.3] md:backdrop-brightness-100 md:z-10 md:w-2/5 md:text-right">
  ...
  function AlignedLeftCard() {
    return (
      sidebar ? (
        ...
        >
          {/* Project information */}
          <div class="p-5 sm:px-5 md:px-0 sm:py-16 md:py-10 backdrop-brightness-[0.3] md:backdrop-brightness-100 md:z-20 md:w-2/5">
