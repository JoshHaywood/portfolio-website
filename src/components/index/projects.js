...
const technologies = ['Handlebars', 'Express JS', ' Socket IO', 'SQLite'];
...
export default function Projects() {
    ...
    return (
        <div className="md:w-2/3 mx-auto pt-8 md:pt-16 xl:pt-36 pb-12 md:pb-20 xl:pb-44"> 
            {/* Heading */}
                ...
                <div className="xl:pt-12 xl:space-x-10 xl:flex items-center text-right"> 
                    ...
                    <div className="flex flex-col items-end">
                        ...
                        <p className="bg-senary pl-10 pr-5 pt-5 pb-5 shadow-md rounded-sm text-gray-300">
                            ...
                            The project portion of my research into web communication systems.
                        </p>

                        <ul className="flex flex-row pt-5 space-x-5">
                            {listItems}
                        </ul>
