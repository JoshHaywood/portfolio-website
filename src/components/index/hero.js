...
export default function Hero() {
    ...
    return (
        ...
        <div class="area" className="w-full h-screen bg-hero-background bg-no-repeat bg-cover bg-center">
            <div className="h-screen 2xl:w-9/12 pt-20 sm:pt-0 md:m-auto flex flex-col md:flex-row justify-center lg:justify-between items-center animate-fade-in-up">
                <div className="flex flex-col space-y-8 items-center md:items-baseline text-center md:text-left mx-6 sm:mx-10 order-1 md:order-none"> {/* Prevents media icons from being flexed in wrong direction */}
                    ...
                    <div className="space-y-8 mt-12"> {/* Prevents text being effected by flex */}
                        ...
                        <p className="text-xl lg:text-2xl font-medium">
                            ...
                            <br></br>
                            I'm an aspiring Web Developer and here's where I showcase my work.
                        </p>
                    </div>

                    <div className="flex space-x-6"> {/* Container to SVGs */}
                        {/* Media Icons */}
                        <a href="https://github.com/El-Goblino/" className="h-8 w-8 hover:text-primary z-10 hover:-translate-y-2 transition duration-300 ease-in-out">
                        ...
                        <a href="https://www.linkedin.com/in/josh-haywood-b70a24233/" className="h-8 w-8 fill-white hover:fill-primary z-10 hover:-translate-y-2 transition duration-300 ease-in-out">
