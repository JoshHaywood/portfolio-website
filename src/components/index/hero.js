...
export default function Hero() {
    ...
    return (
        <div className="h-screen relative flex flex-col animate-fade-in-up">
            {/* Background video */}
            <video autoPlay muted loop className="w-full h-screen object-cover brightness-75 blur-sm"> {/* Object cover allows videos aspect ratio to be overridden */}
            ...
            <div className="absolute lg:left-[20%] h-screen flex flex-col justify-center mx-10 lg:mx-auto z-10 space-y-6"> {/* Prevents media icons from being flexed in wrong direction */}
                ...
                <div className="flex flex-col sm:flex-row items-center sm:items-start space-y-6 sm:space-y-0 space-x-6">
                    <div className="flex pr-[0.9rem] sm:pr-0">
                        ...
                        <a href="https://github.com/El-Goblino/" className="h-4 w-4 -ml-[26px] mt-[10px] z-10">
            ...
            {/* Hero dropdown */}
            <div id="pageDown" className="flex flex-col items-center -mt-16 z-10 w-fit mx-auto">
                <p>View more</p>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512" className="fill-white h-8 w-8 transition duration-300 ease-in-out"> {/* Font Awesome Pro 6.1.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. */}
