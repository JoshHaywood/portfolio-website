...
export default function Hero(props) {
    ...
    return (
        <div className="flex flex-col justify-center relative w-full sm:h-screen min-h-[770px]">
            {/* Background video */}
            ...
            <motion.div 
                ...
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
                transition={{ duration: 0.5, delay: props.scrollButtonDelay, ease: "easeInOut" }}
            >
                    <button onClick={ScrollTo} className="font-medium text-xl hover:text-white transition duration-300 ease-in-out">View more</button>
                    <svg onClick={ScrollTo} className="h-5 w-5 fill-primary mx-auto" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">{/* https://fontawesome.com/icons/chevron-down?s=solid&f=classic */}
