...
export default function Hero() {
    ...
    return (
        <div id="fullscreenElement" className="relative flex flex-col -z-10">
            {/* Background video */}
            <video id="fullscreenElement" autoPlay muted loop playsInline className="w-full h-full fixed object-cover brightness-50 blur-sm" src="../videos/background.mp4" type="video/mp4"> {/* Object cover allows videos aspect ratio to be overridden */} {/* Attribution:https://pixabay.com/videos/circuit-electronics-digital-27725/ by motionstock */}
                Your browser does not support videos
            </video>

            <div id="fullscreenElement" className="absolute max-w-[1000px] h-full left-0 right-0 flex flex-col justify-center mx-auto px-5 xl:px-0 z-50 space-y-6 leading-10 sm:leading-none">
                {/* Text */}
