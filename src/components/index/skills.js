    ...
    >
      ...
      <div class="flex flex-col md:flex-row md:w-full items-center md:items-start mt-[4rem] space-y-5 md:space-y-0 md:space-x-5">
        {cards.map((card, index) => (
          <div
            key={index}
            class="w-[350px] h-[366px] md:h-[423px] lg:h-[366px] bg-tertiary border-b-2 border-primary rounded-sm space-y-3 hover:-translate-y-5 transition duration-300 ease-in-out"
          >
            <svg
