...
export default function Contact() {
  return (
    <motion.div
      ...
      viewport={{ once: true }}
      className="flex flex-col lg:flex-row space-y-16 lg:space-y-0 lg:space-x-10"
    >
      <div className="w-full lg:w-[55%]">
        ...
        {/* Contact buttons */}
        <div className="flex flex-col sm:flex-row lg:flex-col xl:flex-row space-y-5 sm:space-y-0 lg:space-y-5 xl:space-y-0 sm:space-x-5 lg:space-x-0 xl:space-x-5 pt-8">
          <a
            href="https://www.linkedin.com/in/josh-haywood"
          ...
          >
            <Button class="relative w-full flex flex-row space-x-5 items-center px-5 py-2.5 hover:ring ring-primary ring-opacity-40 transition duration-300 ease-in-out bg-tertiary">
              ...
              <label className="pt-1 font-semibold text-sm text-gray-400 hover:cursor-pointer">
                Josh Haywood
              </label>
            </Button>
          </a>
      ...
      >
        <div className="mb-4">
          ...
          <input
            className="w-full px-3 py-2 mb-3 text-sm text-gray-400 bg-tertiary rounded shadow focus:outline-none"
            type="text"
            autoComplete="off"
            placeholder="Name"
            required
