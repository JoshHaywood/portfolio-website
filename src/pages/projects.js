...
export default function Projects(props) {
    ...
    return (
        <>
            ...
            <motion.div 
                class="pt-36 sm:pt-44 pb-20 md:pb-48 max-w-[1000px] mx-5 lg:mx-auto space-y-12"
            ...
            >        
                ...
                <motion.div variants={containerVariants} initial="hidden" whileInView="visible" viewport={{ once: true }} class="space-y-8 md:space-y-0 md:grid grid-rows-2 grid-cols-2 xl:grid-cols-3 gap-x-5 gap-y-6"> 
                    {items.map((items) => 
                        //Project card      
                        <div class="hover:-translate-y-4 transition duration-300 ease-in-out">                      
                            <motion.div variants={listVariants} class="shadow-md shadow-[rgba(76,107,193,0.2)] rounded-md sm:mx-16 md:mx-0">
                                <div class="bg-tertiary rounded-md px-3 pb-5 lg:pb-60 lg:max-h-[280px] w-full">
                                    {/* Card */}
                                    <div class="flex justify-between">
                                        ...
                                        >
                                            <svg class="h-auto w-8 pt-4 fill-primary" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"> {/* Attribution: https://fontawesome.com/icons/folder?s=regular */}
                                        ...
                                        <div class="flex flex-row space-x-2">
                                            <a href={items.projectLink}>
                                                <svg class="h-auto w-5 pt-[1.3rem] fill-secondary-text hover:fill-secondary-text-hover transition duration-300 ease-in-out" xmlns="http://www.w3.org/2000/svg" alt="globe icon" viewBox="0 0 512 512"> {/* Attribution: https://fontawesome.com/icons/earth-europe?s=solid */}
                                    ...
                                    >
                                        {/* Text */}
                                        <div class="space-y-3 mt-3 lg:flex flex-col"> {/* Specific height to keep cards same dimensions */}
                                            <h3 class="font-semibold text-2xl text-gray-300 transition duration-300 ease-in-out">{items.heading}</h3>
                                            
                                            <p class="text-gray-400">{items.textFirst}</p>
                                            <p class="text-gray-400">{items.textSecond}</p>
                                        </div>
                                    </Link>
                                </div>
                                ...
                                <Link 
                                    ...
                                    onClick={() => {document.documentElement.scrollTop = 0}}
                                >
                                    <div class="bg-tertiary text-center rounded-md rounded-t-none p-3 mt-1">
                                        <p class="text-primary-text hover:text-secondary-text">View Project →</p>
                                    </div>
                                </Link>
                            </motion.div>
                        </div>
