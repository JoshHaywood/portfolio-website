        ...
        <>
            ...
            <div className="flex flex-col md:flex-row max-w-[1000px] mx-auto py-16 md:py-32 px-5">
                ...
                >
                    ...
                    <div className="py-10 md:flex space-y-10 items md:space-y-0 md:space-x-10 border-y-2 border-primary">
                        <div className="space-y-10 w-3/4 md:w-full mx-auto md:mx-0">
                            <h2 className="font-medium text-3xl text-center md:text-left">Features</h2>
                        ...
                        <div className="space-y-10 w-3/4 md:w-full mx-auto md:mx-0">
                            <h3 className="font-medium text-3xl text-center md:text-left">Structure</h3>
                            <ul className="space-y-10">
                    ...
                    <div className="space-y-3">
                        <h4 className="font-semibold text-3xl text-center md:text-left">Target</h4>
                        <p>{props.target}</p>
                    </div>
                    ...
                    <div className="space-y-3">
                        <h5 className="font-semibold text-3xl text-center md:text-left">Issues</h5>
                        <p>{props.issues}</p>
                    </div>
                    ...
                    <div className="space-y-3">
                        <h6 className="font-semibold text-3xl text-center md:text-left">Resolutions</h6>
                ...
                >
                    ...
                    <div className="absolute top-0 md:top-[6rem] bottom-0 flex flex-row md:flex-col md:left-0 right-0 items-center space-x-3 md:space-x-0 md:space-y-10 pb-10 md:pb-0">
                        <a href={props.projectLink}>
                            <svg className="h-auto w-8 hover:-translate-y-2 fill-secondary-text hover:fill-secondary-text-hover transition duration-300 ease-in-out" xmlns="http://www.w3.org/2000/svg" alt="globe icon" viewBox="0 0 512 512"> {/* Attribution: https://fontawesome.com/icons/earth-europe?s=solid */} 
