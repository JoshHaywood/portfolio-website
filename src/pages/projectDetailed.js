    ...
    return (
        <>
            <div class="relative flex flex-col justify-center mt-[51px]">
                {/* Background Image */}
                <div class="overflow-hidden w-[screen]"> {/* Container to prevent overflow */}
                    <motion.div
                        initial= {{ scale: 1.5 }}
                        animate={{ scale: 1 }}
                    ...
                    >
                        ...
                        <img class="max-w-[640px] sm:max-w-[760px] md:hidden" src={props.projectImage}></img>

                        {/* Replace img with background image to cover screen whilst maintaining aspect ratio */}
                        <div class="hidden md:flex md:h-[40vh]" style={{backgroundImage: `url("${props.projectImage}")`}}></div>
                    </motion.div>
                </div>
                ...
                > 
                    <div class="space-y-3 text-center inline-block p-5 pb-8 rounded-md bg-secondary">
                        <h1 class="inline-block mx-auto shadow-md sm:text-5xl md:text-6xl font-semibold">{props.heading}</h1>
                ...
                >
                    ...
                    <div class="py-10 md:flex space-y-10 items md:space-y-0 md:space-x-10 border-y-2 border-primary">
                        <div class="space-y-10 w-3/4 md:w-full mx-auto md:mx-0">
                            <h2 class="font-medium text-3xl text-center md:text-left">Features</h2>
                            <ul class="space-y-10">
                                {features.map((features) =>
                                    <li class="list-disc marker:text-primary ml-4 text-2xl align-right ">{features}</li>
                                )}
                            </ul>
                        </div>

                        <div class="space-y-10 w-3/4 md:w-full mx-auto md:mx-0">
                            <h3 class="font-medium text-3xl text-center md:text-left">Structure</h3>
                            <ul class="space-y-10">
                                {structure.map((structure) =>
                                    <li class="list-disc marker:text-primary ml-4 text-2xl">{structure}</li>
                                )}
                            </ul>
                        </div>
                    </div>
                    ...
                    <img class="mx-auto rounded-sm" src={props.targetImage} alt="Image of project"></img>
                    ...
                    <img class="mx-auto rounded-sm" src={props.issuesImage} alt="Image of project"></img>

                    <div class="space-y-3">
                        <h6 class="font-semibold text-3xl text-center md:text-left">Resolutions</h6>
                ...
                >
                    ...
                    <div class="absolute top-0 md:top-[6rem] bottom-0 flex flex-row md:flex-col md:left-0 right-0 items-center space-x-3 md:space-x-0 md:space-y-10 pb-10 md:pb-0">
                        <a href={props.projectLink}>
                            <svg class="h-auto w-8 hover:-translate-y-2 fill-secondary-text hover:fill-secondary-text-hover transition duration-300 ease-in-out" xmlns="http://www.w3.org/2000/svg" alt="globe icon" viewBox="0 0 512 512"> {/* Attribution: https://fontawesome.com/icons/earth-europe?s=solid */} 
