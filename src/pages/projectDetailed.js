          ...
          <div class="absolute top-0 md:top-[6rem] bottom-0 flex flex-row md:flex-col md:left-0 right-0 items-center space-x-3 md:space-x-0 md:space-y-10 pb-10 md:pb-0">
            <a href={props.projectLink}>
              ...
              <svg
                ...
                viewBox="0 0 512 512"
                alt="globe icon"
                class="h-auto w-8 hover:-translate-y-2 fill-secondary-text hover:fill-secondary-text-hover transition duration-300 ease-in-out"
                >
            ...
            <a href={props.repoLink}>
              ...
              <svg 
                ...
                viewBox="0 0 496 512"
                alt="Github logo"
                class="h-auto w-8 hover:-translate-y-2 text-secondary-text hover:text-secondary-text-hover transition duration-300 ease-in-out"
              >
