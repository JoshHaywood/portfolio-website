<template>
  <div>
    ...
    <!-- Section -->
    <div class="flex flex-col md:flex-row justify-between items-center md:items-start max-lg:space-x-10 max-mb:pb-12">
      <div class="md:w-2/3 flex flex-col space-y-5">
